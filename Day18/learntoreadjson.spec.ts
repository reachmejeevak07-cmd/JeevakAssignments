...
import credentials from "../../Data/cred.json" // credentials is holding 2 data 

/* credentials --> [ TCase1, TCase2 ]*/

// test.describe.serial(`Login tests using 2 different data set in serial mode`,async () => { // serial way of execution
    
test.describe(`Login tests using 2 different data set in serial mode`,async () => {
