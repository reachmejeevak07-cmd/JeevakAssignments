...
await uploadFile.setInputFiles([path.join(__dirname,`../../Data/selenium.png`)])
...
const filePath1 = path.join(__dirname,`../../Data/flower.jpg`)
const filePath2 = path.join(__dirname,`../../Data/wifi.png`)
